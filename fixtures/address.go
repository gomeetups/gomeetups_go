...
var Addresses = map[string]models.Address{
	"e7b33956-c64c-4643-830d-e681663528e5": {
		...
		Lat:              40.754336,
		Long:             -73.968502,
		AddressLine1:     sql.NullString{String: "928 2nd Ave", Valid: true},
		FormattedAddress: sql.NullString{String: "928 2nd Ave\nNew York, NY 10022\n", Valid: true},
		Country:          sql.NullString{String: "US", Valid: true},
		State:            sql.NullString{String: "NY", Valid: true},
		City:             sql.NullString{String: "New York", Valid: true},
		ZipCode:          sql.NullString{String: "10022", Valid: true},
		TimeZone:         sql.NullString{String: "America/New_York", Valid: true},
		MapsLink:         sql.NullString{String: "https://www.google.com/maps/place/Sip+Sak/@40.754364,-73.9707237,17z/data=!3m1!4b1!4m5!3m4!1s0x89c258e2f309a3e1:0x349646006d6ae1a2!8m2!3d40.754364!4d-73.968535", Valid: true},
	...
	"15baeb85-ecee-4363-86c8-0133cea23809": {
		...
		Lat:              40.74387,
		Long:             -73.9221448,
		AddressLine1:     sql.NullString{String: "42-03 Queens Blvd", Valid: true},
		FormattedAddress: sql.NullString{String: "42-03 Queens Blvd\nSunnyside, NY 11104\n", Valid: true},
		Country:          sql.NullString{String: "US", Valid: true},
		State:            sql.NullString{String: "NY", Valid: true},
		City:             sql.NullString{String: "New York", Valid: true},
		ZipCode:          sql.NullString{String: "11104", Valid: true},
		TimeZone:         sql.NullString{String: "America/New_York", Valid: true},
		MapsLink:         sql.NullString{String: "https://www.google.com/maps/place/42-03+Queens+Blvd,+Sunnyside,+NY+11104/@40.743874,-73.9243335,17z/data=!3m1!4b1!4m5!3m4!1s0x89c25ed9b2e3016b:0xd8eac585eecdeac5!8m2!3d40.74387!4d-73.9221448", Valid: true},
